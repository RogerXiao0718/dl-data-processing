...
def main():
    result_label_dir = os.path.join(os.getcwd(), '../yolov5/runs/detect/48times_augmentation_K_Fold_0/labels')
    ...
    answer_label_dir = os.path.join(os.getcwd(), '../Datasets/K_Fold/48times_augmentation_for_yolov5/K_Fold_0/labels/val')
    image_dir = os.path.join(os.getcwd(), '../Datasets/K_Fold/48times_augmentation_for_yolov5/K_Fold_0/images/val')
